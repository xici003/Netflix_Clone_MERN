  ...
  return (
    <div className="hero-bg h-screen w-ful">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        >
          <input
            className="p-2 rounded-full flex-1 bg-gray-600/60 border border-white px-8 l shadow-sm"
            type="email"
          ...
          <button className="text-white bg-red-700 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-3 rounded-full flex justify-center items-center">
            Get Started
